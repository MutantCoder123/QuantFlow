...
REM The retired smart_api_feed.py (dead Angel One code) and nse_feed.py (never
REM existed) are replaced with the services that actually run: upstox_feed.py and
REM macro_worker.py.
